<?php
/**
 * Amortez - About Block 01 (PHP)
 * Sayfa PHP formatında çalışır; menü linkleri .php dosyalarına yönlendirir.
 */
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!-- Page Title -->
        <section class="page-title p_relative pt_250 pb_170 centred" style="background-image: url(assets/images/background/page-title.jpg);">
            <div class="bg-layer p_absolute r_100 t_0" style="background-image: url(assets/images/background/page-title.png);"></div>
            <div class="large-container">
                            ...
                            <div class="footer-widget gallery-widget ml_60">
                                ...
                                <div class="widget-content">
                                    <ul class="image-list clearfix">
                                        <li><figure class="image"><a href="project-details.html"><img src="assets/images/resource/footer-gallery-1.jpg" alt=""></a></figure></li>
                                        <li><figure class="image"><a href="project-details.html"><img src="assets/images/resource/footer-gallery-2.jpg" alt=""></a></figure></li>
                                        <li><figure class="image"><a href="project-details.html"><img src="assets/images/resource/footer-gallery-3.jpg" alt=""></a></figure></li>
                                        <li><figure class="image"><a href="project-details.html"><img src="assets/images/resource/footer-gallery-4.jpg" alt=""></a></figure></li>
                                        <li><figure class="image"><a href="project-details.html"><img src="assets/images/resource/footer-gallery-5.jpg" alt=""></a></figure></li>
                                        <li><figure class="image"><a href="project-details.html"><img src="assets/images/resource/footer-gallery-6.jpg" alt=""></a></figure></li>
                                        <li><figure class="image"><a href="project-details.html"><img src="assets/images/resource/footer-gallery-7.jpg" alt=""></a></figure></li>
                                        <li><figure class="image"><a href="project-details.html"><img src="assets/images/resource/footer-gallery-8.jpg" alt=""></a></figure></li>
                                        <li><figure class="image"><a href="project-details.html"><img src="assets/images/resource/footer-gallery-9.jpg" alt=""></a></figure></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
